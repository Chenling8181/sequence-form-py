...
def init_efg(num_ranks=11,
    ...
    if integer:
        ...
        rollout_combinations1 = 1.0 / float(deck_size * (deck_size - 1) * \
                                     (deck_size - 2))
        rollout_combinations2 = 1.0 / float(deck_size * (deck_size - 1) * \
                                     (deck_size - 2) * (deck_size - 3))
        rollout_combinations3 = 1.0 / float(deck_size * (deck_size - 1) * \
                                     (deck_size - 2) * (deck_size - 3) * (deck_size - 4))                                                                          
    ...
    def _p_chance(rnd, board, i, j):
        if rnd == 0:
            ...
            if i == board[rnd - 1] and j == board[rnd - 1]:
                return 0
            elif i == board[rnd - 1] or j == board[rnd - 1] or i == j:
                return 4 * rollout_combinations1
            else:
                return 8 * rollout_combinations1
        elif rnd == 2:
            if i == j == board[rnd - 1] or i == j == board[rnd - 2] or i == board[rnd - 1] == board[rnd - 2] or j == board[rnd - 1] == board[rnd - 2]:
                return 0
            elif i == board[rnd - 1] or j == board[rnd - 1] or i == j:
                return 4 * rollout_combinations2
            else:
                return 8 * rollout_combinations2
        elif rnd == 3:
            if i == j == board[rnd - 1] or i == j == board[rnd - 2] or i == j == board[rnd - 3] or i == board[rnd - 1] == board[rnd - 2] or j == board[rnd - 1] == board[rnd - 2] or i == board[rnd - 1] == board[rnd - 3] or i == board[rnd - 2] == board[rnd - 3] or j == board[rnd - 1] == board[rnd - 3] or j == board[rnd - 2] == board[rnd - 3]:
                return 0
            elif i == board[rnd - 1] or j == board[rnd - 1] or i == j:
                return 4 * rollout_combinations3
            else:
                return 8 * rollout_combinations3
